...
const indexBody = `<section class="home-hero">
  <div class="hero-main">
    <p class="hero-kicker">会社・店舗・施設の備蓄を確認</p>
    <h1>地震・台風・停電・断水に備える<br>事業所防災用品比較</h1>
    <p class="hero-sub">何を買うかの前に、何が止まるかを決める。人数、待機日数、用途から必要な備蓄を見ます。</p>
    <div class="hero-actions">
    ...
    <div class="hero-stats" aria-label="掲載情報">
      ...
      <span><strong>${esc(updatedDate())}</strong>更新</span>
    </div>
  </div>
...
<section class="section decision-strip" aria-label="購入前の確認順">
  <div><strong>人数</strong><span>従業員、来客、利用者を分けて最大人数を見る</span></div>
  <div><strong>止まるもの</strong><span>水、電気、トイレ、交通のどれが止まるかを見る</span></div>
  <div><strong>商品条件</strong><span>容量、回数、保存年数、レビュー件数を確認する</span></div>
</section>
