...
const pageNotes = {
  ...
  'hoikuen-bousai': {
    ...
    disasters: ['地震', '台風', '停電', '断水'],
    conclusion: '保育園の備蓄は、園児が食べられるものを確認してから人数分をそろえます。',
    mustHave: ['保存水', '年齢に合う非常食・ミルク', 'おむつ・衛生用品', '防寒用品', '職員用の備蓄'],
    problem: '保育園の非常食・防災セットを、対象年齢、原材料、調理に必要な水や熱源、配布単位で比較します。園児用と職員用を分けて、足りない備蓄を確認してください。',
    checks: ['授乳・離乳食・幼児食を分け、普段の食事に合う候補を選ぶ', '「アレルギー対応」の表示だけで決めず、園児ごとに原材料を照合する', '停電・断水時にも準備できるか、水・熱源・食器の要否を確認する', '1箱の袋数と1袋の量を確認し、配布予定の食数から発注する', '到着時の賞味期限、保管温度、開封後の扱いを販売店に確認する'],
    avoid: '長期保存やレビューの高さだけでは、園児に合うかは判断できません。月齢や食事形態、個別のアレルギー対応を保護者・園の担当者と確認し、職員用の食料とは分けて発注してください。',
    related: ['emergency-food-office', 'water-food-stock', 'toilet-office', 'bcp-stockpile-checklist'],
    faq: [
      ['保育園の防災備蓄は何日分必要ですか？', '園の災害計画と自治体の案内を確認し、引き渡しまでの待機時間に応じて決めます。一律の日数だけで発注せず、園児と職員それぞれの人数、提供する食事の回数、個別食を整理してください。'],
      ['乳児と幼児の非常食は同じものでよいですか？', '月齢や食事形態が異なるため、一括で選ばないでください。授乳が必要な子、離乳食の子、幼児食の子に分け、普段使うミルクや食べ慣れた食品をもとに、対象年齢と準備方法を確認します。'],
      ['アレルギー対応の非常食なら全員に配れますか？', '表示だけで全員に配れるとは判断できません。園児ごとの原因食物と商品の最新の原材料表示を照合し、不明点はメーカーに確認してください。配布時に取り違えない保管・表示方法も決めておきます。'],
      ['園児30人に2回食事を出す場合、何食必要ですか？', '計算例では園児分は30人×2回で60食です。ただし、ミルク・離乳食・個別食は別に数え、職員分も追加します。商品の1袋が園児1人の1食分に相当するとは限らないため、内容量と配布方法を確認してください。'],
      ['停電・断水時の非常食は何を確認しますか？', 'そのまま食べられるか、水や湯を加える必要があるか、食べられるまでの時間を確認します。調理用の水、食器、衛生用品も別に数え、園で準備・配布できる方法か確認してから購入してください。']
    ]
  },
  'toilet-office': {
