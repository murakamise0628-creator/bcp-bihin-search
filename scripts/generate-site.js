...
const indexBody = `<section class="hero visual-hero">
  <div class="hero-copy">
    <span class="hero-kicker">会社・店舗・施設向け</span>
    <h1><span>事業所防災用品</span><span>比較</span><span>人数と止まるものから</span><span>選ぶ</span></h1>
    <p class="hero-sub">社員が帰れない。<br>水が止まる。電気が落ちる。<br>備蓄品は、起きることから逆算します。</p>
    <p class="lead">会社、店舗、保育園、介護施設、飲食店向けに、防災備蓄品を人数・待機日数・災害別に整理しています。簡易トイレ、保存水、非常食、ポータブル電源を比較し、楽天市場で価格と在庫を確認できます。</p>
  ...
  <aside class="hero-side" aria-label="発注前に見る比較候補">
    <div class="research-badge"><strong>確認順</strong><span>最初に見るのは、商品名ではなく人数・停止するライフライン・置き場所です。</span></div>
    <div class="supply-shelf">
      <div class="showcase-head"><strong>よく比較される備蓄候補</strong><span class="pill">価格・在庫を確認</span></div>
...
<section class="section two">
  <article class="card decision-note"><p class="eyebrow">買う前の順番</p><h2>人数 → 場面 → 商品の順で見る</h2><ol class="steps"><li>従業員、来客、利用者の最大人数を決める</li><li>社内待機、断水、停電、帰宅困難者のどれが起きるかを見る</li><li>水、トイレ、電源、食料を別々に不足確認する</li><li>最後に価格、容量、レビュー、保存年数を比較する</li></ol></article>
...
<section class="section card decision-note">
  <h2>買う前に見ること</h2>
...
${structuredData(
  websiteJsonLd(),
  webPageJsonLd(
    '事業所防災用品比較｜会社・店舗の備蓄を人数から確認',
    '会社、店舗、保育園、介護施設、飲食店向けに、防災備蓄品を人数、待機日数、地震、台風、停電、断水の想定から比較できます。簡易トイレ、保存水、非常食、ポータブル電源の価格・在庫確認に進めます。',
    `${siteUrl}/`
  ),
