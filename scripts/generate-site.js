...
const indexBody = `<section class="hero visual-hero">
  <div>
    <span class="hero-kicker">事業所の備蓄を、買う前に整理する</span>
    <h1>事業所防災ナビ</h1>
    <p class="lead">防災用品を「セットで買って終わり」にしないための確認ページです。人数、待機日数、断水、停電、帰宅困難者を先に整理してから、必要な備蓄と商品候補を見ます。</p>
  ...
  <aside class="hero-showcase" aria-label="比較できる防災用品の例">
    <div class="showcase-head"><strong>実際の商品候補</strong><span class="pill">価格・仕様は購入前確認</span></div>
    <div class="showcase-grid">${showcaseCards}</div>
    <div class="field-note"><strong>商品名より先に、人数・日数・使う場面を決める。</strong><span>そのあとで価格、レビュー件数、容量、保存年数を横並びで見ます。</span></div>
  </aside>
</section>
<section class="section">
  <div class="section-title"><div><p class="eyebrow">用途から探す</p><h2>起きることから選ぶ</h2></div></div>
...
<section class="section">
  <div class="section-title"><div><p class="eyebrow">不足しやすい備蓄</p><h2>最初に確認する3項目</h2></div></div>
