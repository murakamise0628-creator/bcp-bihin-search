...
function siteFooter() {
  return `<footer class="site-footer"><span>© 2026 事業所防災ナビ / 運営者: Jigyousho Bousai Navi Editorial</span><nav aria-label="運営情報"><a href="${siteUrl}/site-policy.html">運営情報・広告掲載・プライバシー</a></nav></footer>`;
}
...
function webPageJsonLd(title, description, canonical, citationUrls = []) {
  return jsonLd({
    ...
    publisher: {
      '@type': 'Person',
      name: 'Jigyousho Bousai Navi Editorial',
      url: `${siteUrl}/`
    },
...
<section class="section two">
  <article class="card"><h2>運営情報</h2><dl class="spec-grid"><div><span>サイト名</span><strong>事業所防災ナビ</strong></div><div><span>運営者</span><strong>Jigyousho Bousai Navi Editorial</strong></div><div><span>サイトURL</span><strong>${siteUrl}/</strong></div><div><span>更新日</span><strong>2026年7月23日</strong></div></dl></article>
